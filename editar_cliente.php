    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="col-lg-8 col-lg-offset-2 detailed mt">
                        ...
                        <form role="form" class="form-horizontal" method="get" action="editar_cliente_database.php">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="text" placeholder="Nombre del cliente" name="nombre" id="nombre" class="form-control" value="<?php echo $nombre; ?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="email" placeholder="Correo del cliente" name="correo" id="correo" class="form-control" value="<?php echo $correo; ?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="number" placeholder="Edad del cliente" name="edad" id="edad" class="form-control" value="<?php echo $edad;?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="text" placeholder="Télefono del cliente" name="telefono" id="telefono" class="form-control" value="<?php echo $telefono; ?>">
                            </div>
                          </div>
                          ...
                          <input type="hidden" name="id_cliente" value=<?php echo $id_cliente; ?>>
                            ...
                            <div class="col-lg-offset-2 col-lg-12">
                              <button class="btn btn-info" type="button">Editar Cliente</button>
