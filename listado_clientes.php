...
//$conn = pg_connect("host=db-instancia.ccwm7dhw4cau.us-east-1.rds.amazonaws.com port=5432 user=postgres password=56721449 dbname=base_datos_practicas");
  ...
  $telefono=$row[4];
       ...
       echo             '<td>'; echo $telefono; echo '</td>';
        echo            '<td>';
         ...
         echo          ' <form action="ver_cliente.php" method="get"> ';
echo ' <input type="hidden" name="id_cliente" value=';echo $id_cliente; echo '><button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>';
echo ' </form>';
echo '</td>';
...
echo ' <input type="hidden" name="id_cliente" value=';echo $id_cliente;  echo '><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>';
echo '</form>';;
echo '</td>';
...
echo '<input type="hidden" name="id_cliente" value='; echo $id_cliente; echo '> <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button>';
echo '</form>';
echo '</td>';
