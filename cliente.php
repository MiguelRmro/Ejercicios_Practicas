...
<li class="mt">
<a class="active" href="cliente.php">
  ...
  <span>Formulario Complejo</span>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-user"></i> Registrar cliente</h3>
        <!-- BASIC FORM ELELEMNTS -->

        <div class="col-lg-8 col-lg-offset-2 detailed mt">
                        <h4 class="mb">Información del cliente</h4>
                        <form role="form" class="form-horizontal" method="get" action="cliente_database.php">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="text" placeholder="Nombre del cliente" name="nombre" id="nombre" class="form-control" value="" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="email" placeholder="Correo del cliente" name="correo" id="correo" class="form-control" value="" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="number" placeholder="Edad del cliente" name="edad" id="edad" class="form-control" value="" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                            <input type="text" placeholder="Télefono del cliente" name="telefono" id="telefono" class="form-control" value="" required>
                            </div>
                          </div>
